...
internal sealed class InterfaceDetailsRowsInput : EnumerableRowsInput<InterfaceDetailsRowsInput.InterfaceAddressDto>
{
    [SafeFunction]
    ...
    public static VariantValue InterfaceDetailsFunction(IExecutionThread thread)
    {
